...
//!
//! Provides screen capture capabilities with platform-specific implementations.
...
///
/// Captures video frames from the screen or specific windows.
...
impl ScreenCapture {
    /// Creates a new screen capture instance
    ///
    /// # Arguments
    ///
