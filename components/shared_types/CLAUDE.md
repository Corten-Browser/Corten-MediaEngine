...
### Purpose
Common types, enums, and traits used across all media components. Defines VideoCodec, AudioCodec, MediaSource, VideoFrame, AudioBuffer, MediaError, MediaEngine trait, and other shared interfaces.


### Dependencies

This component has no dependencies (it's a base/foundation component).
